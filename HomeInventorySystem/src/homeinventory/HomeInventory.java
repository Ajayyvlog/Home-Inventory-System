...
public class HomeInventory extends JFrame
{
	...
	JButton newButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\new.png"));
	JButton deleteButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\delete.png"));
	JButton saveButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\save.png"));
	JButton previousButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\previous.png"));
	JButton nextButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\next.png"));
	JButton printButton = new JButton(new ImageIcon("C:\\Users\\OM\\eclipse-workspace\\HomeInventorySystem\\images\\print.png"));
